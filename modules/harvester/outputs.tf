...
output "harvester_protect_security_group_id" {
  value = aws_security_group.protect_harvester.id
...
output "flower_credentials_arn" {
  value = aws_secretsmanager_secret_version.flower_password_harvester.arn
  description = "The ARN of the flower credentials secret"
}
